...
namespace DotNetDesignPatternDemos.Creational.Prototype
{
    ...
    public class CopyConstructors
    {
        ...
        {
            // Same as the previous example with IClonable, but now we have a clone constructor
            var john = new Employee("John", new Address("123 London Road", "London", "UK"));

            // This won't work 
            //var chris = john;
            // So we are trying to clone an object with a clone constructor
            var chris = new Employee(john);

            // Changing the name of Chris by modifying the property "Name" will change the name of John as well
            chris.Name = "Chris";
            WriteLine(john); // oops, John is called Chris now
